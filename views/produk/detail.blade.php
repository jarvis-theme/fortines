...
<li><a href="{{product_image_url($produk->gambar1)}}"> {{HTML::image(url(product_image_url($produk->gambar1)), $produk->nama)}}</a></li>

@endif

@if($produk->gambar2!='')

<li><a href="{{product_image_url($produk->gambar2)}}"> {{HTML::image(url(product_image_url($produk->gambar2,'medium')), $produk->nama)}}</a></li>

@endif

@if($produk->gambar3!='')

<li><a href="{{product_image_url($produk->gambar3)}}"> {{HTML::image(url(product_image_url($produk->gambar3,'medium')), $produk->nama)}}</a></li>

@endif

@if($produk->gambar4!='')

<li><a href="{{product_image_url($produk->gambar4)}}"> {{HTML::image(url(product_image_url($produk->gambar4,'medium')), $produk->nama)}}</a></li>
